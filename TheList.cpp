...
int main()
{
	...
	List342<Child> inputFileChild("inputChild(ren).txt");
	List342<Bird> inputFileBird("inputBird(s).txt");

	if (!inputFileChild.isEmpty())
	{
		cout << "Input File Child: " << inputFileChild << endl;
	}

	if (!inputFileBird.isEmpty())
	{
		cout << "Input File Bird: " << inputFileBird << endl;
	}
